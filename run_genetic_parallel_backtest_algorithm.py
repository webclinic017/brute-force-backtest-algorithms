...
def run(list_symbols, activationtime, timer_global, debug, platform, coreLine, list_chunk_days, chunk_div_size, list_strategies, discord_server):
            ...
            for days in list_chunk_days:
                ...
                for timeFrame in list_timeFrame:
                    ...
                    for chunk_index in range(chunk_div_size):
                        ...
                        gen.backTest(df_kline_chunk_4_backtest, df_backtest_all, timeFrame,strategy, symbol, coreLine, debug, days, chunk_div_size, chunk_index, side)
...
if __name__ == "__main__":
    ...
    activationtime, timer_global, debug, platform, coreLine, list_chunk_days, chunk_div_size, list_strategies, discord_server  = setup.run()
    
    try:

        list_symbols = screener.run(debug, activationtime, discord_server)

        run(list_symbols, activationtime, timer_global, debug, platform, coreLine, list_chunk_days, chunk_div_size, list_strategies, discord_server)
